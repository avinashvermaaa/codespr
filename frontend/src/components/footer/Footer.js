...
const socialIcons = [
  ...
  },
  {
    ...
    link: 'mailto:corporate4avinash@gmail.com',
  },
  {
        ...
        <div className="footer-grid">
          ...
          <div className="footer-column">
            ...
            >
              ...
              <li>
                <a href="https://codespr.netlify.app">About</a>
              </li>
              <li>
                <a href="https://codespr.netlify.app">Use Cases</a>
              </li>
              <li>
                <a href="https://codespr.netlify.app">Contact</a>
              </li>
            </ul>

            <h4 className="footer-title" onClick={() => toggleSection('users')}>
              Users {openSections.users ? '▼' : '▶'}
            </h4>
            <ul className={`footer-list ${openSections.users ? 'active' : ''}`}>
              <li>
                <a href="https://codespr.netlify.app">Status</a>
              </li>
              <li>
                <a href="https://codespr.netlify.app">Pricing</a>
              </li>
              <li>
                <a href="https://codespr.netlify.app">Refund Policy</a>
              </li>
            </ul>
          </div>
          ...
          {/* More Section */}
          <div className="footer-column">
            <h4 className="footer-title" onClick={() => toggleSection('more')}>
              More {openSections.more ? '▼' : '▶'}
            </h4>
            <ul className={`footer-list ${openSections.more ? 'active' : ''}`}>
              <li>
                <a href="https://codespr.netlify.app">Orgs</a>
              </li>
              <li>
                <a href="https://codespr.netlify.app">API</a>
              </li>
              <li>
                <a href="https://codespr.netlify.app">Pricing</a>
              </li>
            ...
            >
              ...
              <li>
                <a href="https://codespr.netlify.app">Tutorials</a>
              </li>
              <li>
                <a href="https://codespr.netlify.app">Tools</a>
              </li>
              <li>
                <a href="https://codespr.netlify.app">Stats</a>
              </li>
            </ul>
          </div>
        </div>
